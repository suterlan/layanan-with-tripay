...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Az-Media <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!-- Page level plugins -->
<script src="<?= base_url('assets/member/vendor/chart.js/Chart.min.js'); ?>"></script>

<!-- Page level custom scripts -->
<script src="<?= base_url('assets/member/js/demo/chart-area-demo.js'); ?>"></script>
<script src="<?= base_url('assets/member/js/demo/chart-pie-demo.js'); ?>"></script>
